...
export default class UserController extends HttpController {
    ...
    async deletePermissionForUser(req: Request, res, next) {
        const output = await this.factory.userService.deleteByPermission({
            ...req.body,
            ...req.params,
        })
        res.status(200).send({
    ...
    async addingPermissionForUser(req: Request, res, next) {
        const output = await this.factory.userService.addingByPermission({
            ...req.body,
            ...req.params,
        })
        res.status(200).send({
    ...
    async updatingRoleForUser(req: Request, res, next) {
        const output = await this.factory.userService.updateForRoleUser({
            ...req.body,
            ...req.params,
        })
        res.status(200).send({
