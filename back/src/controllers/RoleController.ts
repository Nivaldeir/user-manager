...
export default class RoleController extends HttpController {
    ...
    async deletePermissionForUser(req: Request, res, next) {
        const output = await this.factory.roleService.deleteByPermission({
            ...req.body,
            ...req.params,
        })
        res.status(200).send({
    ...
    async addingPermissionForUser(req: Request, res, next) {
        ...
        const output = await this.factory.roleService.addingByPermission({
            ...req.body,
            ...req.params,
        })
        res.status(200).send({
